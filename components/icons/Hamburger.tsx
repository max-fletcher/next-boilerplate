...
const HamburgerIcon = ({ classes = '', width = 20, height = 20, isActive = false }: TIconTypes) => {
  return (
    <svg 
      ...
      style={{width, height}}
    >
      <path d="M4 18L20 18" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4 12L20 12" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4 6L20 6" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
